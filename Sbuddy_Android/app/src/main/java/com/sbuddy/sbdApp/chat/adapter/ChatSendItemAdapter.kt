...
class ChatSendItemAdapter(private val listener: ChatItemListener) : ListAdapter<Chat, ChatSendItemAdapter.ViewHolder>(
    ChatSendItemAdapter.ChatSendItemDiffCallback()) {
        ...
        class ChatSendItemDiffCallback : DiffUtil.ItemCallback<Chat>() {
